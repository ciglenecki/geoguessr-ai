...
def get_example_params(example_index):
    ...
    file_name_to_export1 = img_path[img_path.rfind("/") + 1 : img_path.rfind(".")]
    # Read image
    original_image1 = Image.open(img_path).convert("RGB")

    img_path = example_list[1][0]
    file_name_to_export2 = img_path[img_path.rfind("/") + 1 : img_path.rfind(".")]
    # Read image
    original_image2 = Image.open(img_path).convert("RGB")
    img_path = example_list[2][0]
    file_name_to_export3 = img_path[img_path.rfind("/") + 1 : img_path.rfind(".")]
    # Read image
    original_image3 = Image.open(img_path).convert("RGB")
    img_path = example_list[3][0]
    file_name_to_export4 = img_path[img_path.rfind("/") + 1 : img_path.rfind(".")]
    # Read image
    original_image4 = Image.open(img_path).convert("RGB")
    # Process image
    prep_img_list = [
        preprocess_image(original_image1),
        preprocess_image(original_image2),
        preprocess_image(original_image3),
        preprocess_image(original_image4),
    ]
    original_image_list = [original_image1, original_image2, original_image3, original_image4]
...
class GuidedBackprop:
    ...
    def hook_layers(self):
        ...
        first_layer = list(self.model.backbone.layer4._modules.items())[0][1]
    ...
    def update_relus(self):
        ...
        for pos, module in self.model.backbone.layer4._modules.items():
